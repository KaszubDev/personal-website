        ...
        <section className={withBorder
            ...
            <Container>
                <motion.div
                    ...
                    className="bg-black dark:bg-white text-white dark:text-black rounded-3xl p-8 xs:p-12 md:p-24 text-center overflow-hidden relative"
                >
                    <div className="relative z-10">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6">Let&apos;s work together.</h2>
                        <p className="text-lg md:text-xl text-gray-300 dark:text-gray-600 max-w-xl mx-auto mb-6 xs:mb-10">
                            Need an experienced developer who cares about the details? <br /> I&apos;m available for freelance projects and consulting.
                        </p>
                        <Link
                            href="/contact"
                            className="inline-block bg-white dark:bg-black text-black dark:text-white px-6 py-3 xs:px-8 xs:py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform"
                        >
                            Get in Touch
                        </Link>
                    </div>
